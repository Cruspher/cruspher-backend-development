...
export class ForumMessageController {
  ...
  async addThemeMessage(
    @Req() req: Request,
    @Body() dto: addThemeMessageDto,
    @Res() res: Response,
  ) {
  ...
  async getMessagesByReports(
    @Req() req: Request,
    @Body() dto: getMessagesByReportsDto,
    @Res() res: Response,
  ) {
  ...
  async editThemeMessage(
    @Req() req: Request,
    @Body() dto: editThemeMessageDto,
    @Res() res: Response,
  ) {
  ...
  async getMessagesByThemePagination(
    @Req() req: Request,
    @Param() dto: getMessagesByTheme,
    @Res() res: Response,
  ) {
